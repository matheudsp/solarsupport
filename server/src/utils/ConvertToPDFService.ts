...
const OUTPUT_PDF = 'cache/proposta-servico.pdf';
...
class ConvertToPdfService {
  ...
  async execute() {
    ...
    try {
      ...
      await convertapi.convert('pdf', { File: 'cache/proposta-servico.docx' }).then(function (result) {
          
          // console.log("Converted file url: " + result.file.url);
          
          return result.file.save('cache/proposta-servico.pdf');
        })
        // .then(function (file) {
...
export class ConvertToPdfServiceController {
