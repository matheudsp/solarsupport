...
import { GenerateServiceProposalService } from '../../services/admin/GenerateServiceProposalService';

class GenerateServiceProposalController {
  ...
  async handle(req: Request, res: Response) {
    ...
    const generateProposal = new GenerateServiceProposalService();
...
export { GenerateServiceProposalController }
